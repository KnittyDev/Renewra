...
export default function Footer() {
  return (
    <motion.footer 
      ...
      className="bg-slate-50 border-t border-slate-200 pt-16 pb-8 px-6 md:px-10"
    >
      <div className="max-w-[1200px] mx-auto grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-10 mb-16">
        <div className="col-span-2 lg:col-span-2 flex flex-col gap-4">
          <div className="flex items-center gap-2 text-slate-900">
            <div className="size-6 text-primary">
              <span className="material-symbols-outlined !text-[24px] font-bold">donut_small</span>
            </div>
            <h2 className="text-lg font-bold tracking-tight">Renewra</h2>
          </div>
          <p className="text-slate-500 text-sm max-w-xs leading-relaxed">
            The smartest way to track, manage, and optimize your recurring expenses. Built for modern financial wellness.
          </p>
        </div>
        
        <div className="flex flex-col gap-4">
          <h3 className="font-bold text-slate-900">Product</h3>
          <a className="text-slate-500 hover:text-primary text-sm" href="#">Features</a>
          <a className="text-slate-500 hover:text-primary text-sm" href="#">Pricing</a>
          <a className="text-slate-500 hover:text-primary text-sm" href="#">Integrations</a>
          <a className="text-slate-500 hover:text-primary text-sm" href="#">Changelog</a>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <a className="text-slate-500 hover:text-primary text-sm" href="#">Security</a>
        </div>
      </div>
      
      <div className="max-w-[1200px] mx-auto border-t border-slate-200 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
        <p className="text-slate-400 text-sm">© 2023 Renewra Inc. All rights reserved.</p>
