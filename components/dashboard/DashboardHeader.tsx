  ...
  return (
    <header className="h-20 bg-white border-b border-slate-100 px-8 flex justify-between items-center sticky top-0 z-20">
      <div className="flex items-center gap-4">
        <h1 className="text-xl font-bold text-slate-900 hidden md:block">Dashboard Overview</h1>
      ...
      <div className="flex items-center gap-6">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className="hidden sm:flex items-center gap-2 bg-slate-900 hover:bg-slate-800 text-white px-4 py-2.5 rounded-xl text-sm font-bold shadow-lg shadow-slate-900/10 transition-all"
        >
